...
// if(soma < c){
//     console.log('Essa soma é menor do q C');
// }else{
//     console.log('Essa soma é maior do q C');
// }
...
// let aluno = {
//     nome: "Laís",
//     notas:{ bimestre1: 4, bimestre2: 6, bimestre3: 5, bimestre4: 9 },
// }
// console.log('Aluno(a): '+ aluno.nome);
// let media= (aluno.notas.bimestre1 + aluno.notas.bimestre2 + aluno.notas.bimestre3 + aluno.notas.bimestre4) / 4;

// if(media < 7){
//     console.log('A media do aluno(a) é '+ media + ', Está reprovado')
// }else{
//     console.log('A media do aluno(a) é '+ media + ', Está aprovado');
// }
